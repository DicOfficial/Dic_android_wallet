...
import com.gravilink.zcash.request.*;
...
//    }
    ...
    new Thread(new GetUTXOSRequest(fromAddr, minconf, new WalletCallback<String, List<ZCashTransactionOutput>>() {
      ...
      public void onResponse(String r1, List<ZCashTransactionOutput> r2) {
        Log.d("ZCashTransactionOutput", "onResponse: r2  "+r2.get(0).type);
        if (r1.equals("ok")) {
  ...
  /**
    *@Description TODO rewards transaction
    *@param
    *@return
  **/
  public void createRewardsTransaction_taddr(final String fromAddr,
                                           final String toAddr,
                                           final Long amount,
                                           final Long fee,
                                           final String privateKey,
    ...
    new Thread(new GetUTXOSRequest(fromAddr, minconf, new WalletCallback<String, List<ZCashTransactionOutput>>() {
      ...
      public void onResponse(String r1, List<ZCashTransactionOutput> r2) {
        if (r1.equals("ok")) {
          new CreateRewardsTransaction(fromAddr, toAddr, amount, fee, privateKey, EXPIRY_HEIGHT_NO_LIMIT, onComplete, r2).run();
        } else {
          onComplete.onResponse(r1, null);
        }
      }
