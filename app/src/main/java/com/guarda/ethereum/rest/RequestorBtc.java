...
public class RequestorBtc {
    ...
    public static void getBalanceKmdNew(String address, ApiMethods.RequestListener listener) {
        ...
        Log.d("svcom", "path " + call.request());
        ApiMethods.makeRequest1( address,call, listener);
    }

    public static void getBalanceKmdNew1(String address, ApiMethods.RequestListener listener) {
        Call call = ApiMethods.createKmdApi01().getBalance(address);
        Log.d("svcom", "path " + call.request());
        ApiMethods.makeRequest(call, listener);
    }
    ...
    //第二个地址
    public static void getTransactionsKmdNew1(String address, int from, int to, ApiMethods.RequestListener listener){
        Call call = ApiMethods.createKmdApi01().getTransactions(address, from, to);
        Log.d("getTransactionsKmdNew1", "getTransactionsKmdNew1: "+call.request());
        Log.d("svcom", "path " + call.request());
        //ApiMethods.makeRequest2(address,  from,  to,call, listener);
        ApiMethods.makeRequest(call, listener);
    }
    ...
    public static void getUTXOListKmdNew1(String address, ApiMethods.RequestListener listener) {
        Call call = ApiMethods.createKmdApi01().getUTXOByAddress(address);
        Log.d("Request", "path " + call.request());
        //ApiMethods.makeRequest3(address, call, listener);
        ApiMethods.makeRequest(call, listener);
    }
